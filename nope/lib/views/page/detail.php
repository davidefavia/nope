<div class="panel panel-default content-detail-panel">
  <div class="panel-heading clearfix">
    <h2><i class="fa fa-star" ng-if="content.starred"></i> {{content.title}} <a ng-href="#/content/{{contentType}}/edit/{{content.id}}" class="btn btn-default btn-xs pull-right"><i class="fa fa-pencil"></i></a></h2>
  </div>
