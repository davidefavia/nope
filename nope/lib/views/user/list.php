<div id="user" class="row">
  <div class="list-column col" ng-class="{'col-md-4 col-sm-6':!nope.isIframe}">
    ...
    <div class="list-group">
      <div class="list-group-item ng-cloak" ng-show="(!usersList.length && q.query) || (!metadata.count && !q.query)">No user found<span ng-if="q.query"> with filter "{{q.query}}"</span>.</div>
